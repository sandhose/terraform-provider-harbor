...
// NewGetSystemCVEWhitelistParams creates a new GetSystemCVEWhitelistParams object
// with the default values initialized.
func NewGetSystemCVEWhitelistParams() *GetSystemCVEWhitelistParams {

	return &GetSystemCVEWhitelistParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetSystemCVEWhitelistParamsWithTimeout creates a new GetSystemCVEWhitelistParams object
...
// NewGetSystemCVEWhitelistParamsWithContext creates a new GetSystemCVEWhitelistParams object
...
// NewGetSystemCVEWhitelistParamsWithHTTPClient creates a new GetSystemCVEWhitelistParams object
...
/*GetSystemCVEWhitelistParams contains all the parameters to send to the API endpoint
for the get system c v e whitelist operation typically these are written to a http.Request
*/
